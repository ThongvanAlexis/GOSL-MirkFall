...
Future<int> runCheck({String? rootPath}) async {
  ...
  if (violations.isEmpty) {
    stdout.writeln('check_avoid_flutter_map_leak: OK ($scanned file(s), zero maplibre_gl imports outside lib/infrastructure/map/)');
    return 0;
  }

  stderr.writeln('check_avoid_flutter_map_leak: ${violations.length} forbidden import(s) outside lib/infrastructure/map/:');
