...
- [ ] 07-map-integration/07-07-integration-verification-PLAN.md — Wave 7: integration_test/airplane_mode_test.dart (MAP-01 subset of QUAL-05) + first_launch_world_copy_test.dart (MAP-07 auto-heal) + map_end_to_end_test.dart (MockHTTPServer + full user journey) + phase_07_navigation_test.dart + checkpoint:human-verify physical device smoke (Android Pixel 4a + iOS via CI IPA+sideload) + docs/phase-07-smoke.md archive
