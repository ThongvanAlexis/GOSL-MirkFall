...
void main() {
  ...
  test('session_v1.json migrates to session_v2.json payload byte-equal', () {
    final fixtureDir = p.join(Directory.current.path, 'test', 'fixtures', 'json');
    ...
    final migratedPayload = migrator.migrate(fromVersion: v1Envelope.schemaVersion, toVersion: 2, payload: v1Envelope.payload);
