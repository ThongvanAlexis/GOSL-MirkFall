...
/// Bright heavenly clouds fog — light noise-modulated overlay with
/// slow drifting motion.
///
/// Phase 09 Wave 0 scaffold. Wave 3 (plan 09-04) supplies the body once
/// Wave 2 plan 09-02 adds `HeavenlyCloudsConfig` to the `MirkStyleConfig`
/// sealed union. Until then, this renderer takes no constructor parameter.
///
// TODO(09-04): accept `HeavenlyCloudsConfig config` once plan 09-02 adds
// the sealed variant. For Wave 0, no config parameter.
