          ...
          return ListView(
            ...
            children: <Widget>[
              ...
              SwitchListTile(
                ...
                title: const Text('Animer curlScale (0 → 10 → 0 sur 20s)'),
                value: MirkRuntimeTunables.instance.curlScaleAnimationEnabled,
                onChanged: (bool v) => MirkRuntimeTunables.instance.curlScaleAnimationEnabled = v,
              ),
              _slider(
                label: 'période (s)',
                value: MirkRuntimeTunables.instance.curlScaleAnimationPeriodSec,
                defaultValue: kMirkFogCurlScaleAnimationPeriodSec,
                min: 5.0,
                max: 60.0,
                onChanged: (v) => MirkRuntimeTunables.instance.curlScaleAnimationPeriodSec = v,
              ),
              _slider(
                label: MirkRuntimeTunables.instance.curlScaleAnimationEnabled ? 'curlScale (static, ignoré si animation ON)' : 'curlScale',
