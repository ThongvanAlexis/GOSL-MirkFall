...
/// Type-safe wrapper for mirk-style identifiers.
///
/// See [SessionId] doc-comment for the prefix-in-value rationale and the
/// extension-type cost model — same shape, same trade-offs.
extension type const MirkStyleId(String value) {
  /// Prefix embedded in every mirk-style ID.
  static const String prefix = 'mst_';
