...
/// Type-safe wrapper for photo-reference identifiers.
///
/// See [SessionId] doc-comment for the prefix-in-value rationale and the
/// extension-type cost model — same shape, same trade-offs.
extension type const PhotoRefId(String value) {
  /// Prefix embedded in every photo-ref ID.
  static const String prefix = 'phr_';
