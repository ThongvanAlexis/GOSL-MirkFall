...
_InstalledCountry _$InstalledCountryFromJson(Map<String, dynamic> json) => _InstalledCountry(
...
Map<String, dynamic> _$InstalledCountryToJson(_InstalledCountry instance) => <String, dynamic>{
