...
AtmosphericConfig _$AtmosphericConfigFromJson(Map<String, dynamic> json) => AtmosphericConfig(
  ...
  densityBaselineAlpha: (json['densityBaselineAlpha'] as num?)?.toDouble() ?? 0.99,
  featherRadiusFraction: (json['featherRadiusFraction'] as num?)?.toDouble() ?? 0.1,
  edgeSoftness: (json['edgeSoftness'] as num?)?.toDouble() ?? 0.5,
  $type: json['rendererType'] as String?,
);

Map<String, dynamic> _$AtmosphericConfigToJson(AtmosphericConfig instance) => <String, dynamic>{
...
Map<String, dynamic> _$SolidConfigToJson(SolidConfig instance) => <String, dynamic>{
  'colorArgb': instance.colorArgb,
  'baselineAlpha': instance.baselineAlpha,
  'rendererType': instance.$type,
};

CandlelightConfig _$CandlelightConfigFromJson(Map<String, dynamic> json) => CandlelightConfig(
  centerColorArgb: (json['centerColorArgb'] as num?)?.toInt() ?? 0xFFFF8F6A,
  peripheryColorArgb: (json['peripheryColorArgb'] as num?)?.toInt() ?? 0xFFC2542E,
...
Map<String, dynamic> _$CandlelightConfigToJson(CandlelightConfig instance) => <String, dynamic>{
...
HeavenlyCloudsConfig _$HeavenlyCloudsConfigFromJson(Map<String, dynamic> json) => HeavenlyCloudsConfig(
...
Map<String, dynamic> _$HeavenlyCloudsConfigToJson(HeavenlyCloudsConfig instance) => <String, dynamic>{
  'colorArgb': instance.colorArgb,
  'noiseScale': instance.noiseScale,
  'noiseSpeed': instance.noiseSpeed,
  'driftDirectionDeg': instance.driftDirectionDeg,
...
ShaderConfig _$ShaderConfigFromJson(Map<String, dynamic> json) =>
    ShaderConfig(shaderAssetPath: json['shaderAssetPath'] as String, $type: json['rendererType'] as String?);

Map<String, dynamic> _$ShaderConfigToJson(ShaderConfig instance) => <String, dynamic>{
...
UnknownConfig _$UnknownConfigFromJson(Map<String, dynamic> json) {
  ...
  return UnknownConfig(raw: _unknownRawFromJson(_readWholeMap(json, 'raw')), $type: json['rendererType'] as String?);
}

Map<String, dynamic> _$UnknownConfigToJson(UnknownConfig instance) => <String, dynamic>{'raw': _unknownRawToJson(instance.raw), 'rendererType': instance.$type};
