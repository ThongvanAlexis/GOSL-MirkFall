...
mixin _$MirkPaintContext {
 ...
 double get zoomLevel; double get pixelRatio; Duration get sessionElapsed; MirkViewportBbox get viewportBbox; List<VisibleMirkTile> get visibleTiles; List<RevealDisc> get discs; Fix? get currentFix;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MirkPaintContext&&(identical(other.zoomLevel, zoomLevel) || other.zoomLevel == zoomLevel)&&(identical(other.pixelRatio, pixelRatio) || other.pixelRatio == pixelRatio)&&(identical(other.sessionElapsed, sessionElapsed) || other.sessionElapsed == sessionElapsed)&&(identical(other.viewportBbox, viewportBbox) || other.viewportBbox == viewportBbox)&&const DeepCollectionEquality().equals(other.visibleTiles, visibleTiles)&&const DeepCollectionEquality().equals(other.discs, discs)&&(identical(other.currentFix, currentFix) || other.currentFix == currentFix));
}


@override
int get hashCode => Object.hash(runtimeType,zoomLevel,pixelRatio,sessionElapsed,viewportBbox,const DeepCollectionEquality().hash(visibleTiles),const DeepCollectionEquality().hash(discs),currentFix);

@override
String toString() {
  return 'MirkPaintContext(zoomLevel: $zoomLevel, pixelRatio: $pixelRatio, sessionElapsed: $sessionElapsed, viewportBbox: $viewportBbox, visibleTiles: $visibleTiles, discs: $discs, currentFix: $currentFix)';
}
...
@useResult
$Res call({
 double zoomLevel, double pixelRatio, Duration sessionElapsed, MirkViewportBbox viewportBbox, List<VisibleMirkTile> visibleTiles, List<RevealDisc> discs, Fix? currentFix
});
...
/// Create a copy of MirkPaintContext
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? zoomLevel = null,Object? pixelRatio = null,Object? sessionElapsed = null,Object? viewportBbox = null,Object? visibleTiles = null,Object? discs = null,Object? currentFix = freezed,}) {
...
as List<VisibleMirkTile>,discs: null == discs ? _self.discs : discs // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double zoomLevel,  double pixelRatio,  Duration sessionElapsed,  MirkViewportBbox viewportBbox,  List<VisibleMirkTile> visibleTiles,  List<RevealDisc> discs,  Fix? currentFix)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MirkPaintContext() when $default != null:
return $default(_that.zoomLevel,_that.pixelRatio,_that.sessionElapsed,_that.viewportBbox,_that.visibleTiles,_that.discs,_that.currentFix);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double zoomLevel,  double pixelRatio,  Duration sessionElapsed,  MirkViewportBbox viewportBbox,  List<VisibleMirkTile> visibleTiles,  List<RevealDisc> discs,  Fix? currentFix)  $default,) {final _that = this;
switch (_that) {
case _MirkPaintContext():
return $default(_that.zoomLevel,_that.pixelRatio,_that.sessionElapsed,_that.viewportBbox,_that.visibleTiles,_that.discs,_that.currentFix);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double zoomLevel,  double pixelRatio,  Duration sessionElapsed,  MirkViewportBbox viewportBbox,  List<VisibleMirkTile> visibleTiles,  List<RevealDisc> discs,  Fix? currentFix)?  $default,) {final _that = this;
switch (_that) {
case _MirkPaintContext() when $default != null:
return $default(_that.zoomLevel,_that.pixelRatio,_that.sessionElapsed,_that.viewportBbox,_that.visibleTiles,_that.discs,_that.currentFix);case _:
  return null;
...
class _MirkPaintContext implements MirkPaintContext {
   _MirkPaintContext({required this.zoomLevel, required this.pixelRatio, required this.sessionElapsed, required this.viewportBbox, final  List<VisibleMirkTile> visibleTiles = const <VisibleMirkTile>[], final  List<RevealDisc> discs = const <RevealDisc>[], this.currentFix}): assert(zoomLevel >= 0.0, 'MirkPaintContext.zoomLevel must be >= 0'),assert(pixelRatio > 0.0, 'MirkPaintContext.pixelRatio must be > 0'),_visibleTiles = visibleTiles,_discs = discs;
...
@override@JsonKey() List<VisibleMirkTile> get visibleTiles {
...
@override@JsonKey() List<RevealDisc> get discs {
...
@override
int get hashCode => Object.hash(runtimeType,zoomLevel,pixelRatio,sessionElapsed,viewportBbox,const DeepCollectionEquality().hash(_visibleTiles),const DeepCollectionEquality().hash(_discs),currentFix);
...
/// Create a copy of MirkPaintContext
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? zoomLevel = null,Object? pixelRatio = null,Object? sessionElapsed = null,Object? viewportBbox = null,Object? visibleTiles = null,Object? discs = null,Object? currentFix = freezed,}) {
...
as List<VisibleMirkTile>,discs: null == discs ? _self._discs : discs // ignore: cast_nullable_to_non_nullable
as List<RevealDisc>,currentFix: freezed == currentFix ? _self.currentFix : currentFix // ignore: cast_nullable_to_non_nullable
as Fix?,
  ));
}
