...
mixin _$MirkPaintContext {
 ...
 double get zoomLevel; double get pixelRatio; Duration get sessionElapsed;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MirkPaintContext&&(identical(other.zoomLevel, zoomLevel) || other.zoomLevel == zoomLevel)&&(identical(other.pixelRatio, pixelRatio) || other.pixelRatio == pixelRatio)&&(identical(other.sessionElapsed, sessionElapsed) || other.sessionElapsed == sessionElapsed));
}


@override
int get hashCode => Object.hash(runtimeType,zoomLevel,pixelRatio,sessionElapsed);

@override
String toString() {
  return 'MirkPaintContext(zoomLevel: $zoomLevel, pixelRatio: $pixelRatio, sessionElapsed: $sessionElapsed)';
}
...
@useResult
$Res call({
 double zoomLevel, double pixelRatio, Duration sessionElapsed
});
...
/// Create a copy of MirkPaintContext
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? zoomLevel = null,Object? pixelRatio = null,Object? sessionElapsed = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double zoomLevel,  double pixelRatio,  Duration sessionElapsed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MirkPaintContext() when $default != null:
return $default(_that.zoomLevel,_that.pixelRatio,_that.sessionElapsed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double zoomLevel,  double pixelRatio,  Duration sessionElapsed)  $default,) {final _that = this;
switch (_that) {
case _MirkPaintContext():
return $default(_that.zoomLevel,_that.pixelRatio,_that.sessionElapsed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double zoomLevel,  double pixelRatio,  Duration sessionElapsed)?  $default,) {final _that = this;
switch (_that) {
case _MirkPaintContext() when $default != null:
return $default(_that.zoomLevel,_that.pixelRatio,_that.sessionElapsed);case _:
  return null;
...
class _MirkPaintContext implements MirkPaintContext {
   _MirkPaintContext({required this.zoomLevel, required this.pixelRatio, required this.sessionElapsed}): assert(zoomLevel >= 0.0, 'MirkPaintContext.zoomLevel must be >= 0'),assert(pixelRatio > 0.0, 'MirkPaintContext.pixelRatio must be > 0');
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MirkPaintContext&&(identical(other.zoomLevel, zoomLevel) || other.zoomLevel == zoomLevel)&&(identical(other.pixelRatio, pixelRatio) || other.pixelRatio == pixelRatio)&&(identical(other.sessionElapsed, sessionElapsed) || other.sessionElapsed == sessionElapsed));
}
...
/// Create a copy of MirkPaintContext
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? zoomLevel = null,Object? pixelRatio = null,Object? sessionElapsed = null,}) {
